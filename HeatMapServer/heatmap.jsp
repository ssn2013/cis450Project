	...
	function reloadMap() {
		...
		xmlhttp.onreadystatechange = function() {
			if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
				...
				map.setCenter(new google.maps.LatLng(pointsArray[0].latitude,
						pointsArray[0].longitude));
...
<body>
	...
	<div>
		<table>
			...
			<tr>
				<td colspan="2"><button type="button" onclick="testAjax()">Change
						Content</button></td>
			</tr>
			<tr>
				<td colspan="2"><button type="button" onclick="reloadMap()">Reload
						Map</button></td>
			</tr>
		</table>
		<br />
